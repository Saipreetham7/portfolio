    ...
    <div className="projects-container" id="projects">
      ...
      <div className="projects-grid">
        <div className="project">
          <a
            href="https://chatapp-fullstack-5uoy.onrender.com/"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <a
            href="https://github.com/Saipreetham7/ChatApp"
            target="_blank"
            rel="noreferrer"
          >
            <GitHub />
          ...
          <p>
            Built a MERN-based real-time chat app with Socket.io, React, and a
